...
def GetPlate(car_image, show = False):
    ...
    if show:
        plt.savefig('1.Car-grey-binary.png', bbox_inches = 'tight')
        plt.show()
    ...
    if show:
        plt.savefig('2.Car-Contrast.png', bbox_inches = 'tight')
        plt.show()
    ...
    if(flag==0):
        ...
        for region in regionprops(label_image):
            ...
            if region_height >= min_height and region_height <= max_height and region_width >= min_width and region_width <= max_width and region_width > region_height:
                ...
                ax1.add_patch(rectBorder)
        if show:      
            plt.savefig('3.Car-Plate.png', bbox_inches = 'tight')  
            plt.show()
        # print(plate_like_objects[0])
...
if __name__ == "__main__":
    GetPlate('../data/whitecar.png', True)
